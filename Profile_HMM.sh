#!/bin/bash
#DESCRIPTION: This script compute automatycally a Profile_HMM and compute the confusion matrix, ACC and MCC for 10 different E_value
#To start, you have to pass your customize table of data for the training.
...
#ATTENTION1: to run it you need to download all the file and leave them in the repository organization
#ATTENTION2: you need to replace your working directory in the different shell scripts(have to be adjusted).
...
#modify the two positive and negative testing set
#run the hmmsearch against both sets
...
#compute all the values for the confusion matrix
